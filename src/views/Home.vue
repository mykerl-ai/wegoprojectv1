<template>
  <Hero>
    ...
    <h1 class="lg:text-2xl md:8xl tracking-wide leading-10 text-xl -mt-12 md:-mt-20 text-white font-semibold">Revolutionary <br> End-to-End IPTV/OTT Combined Platform</h1>
    </template>
