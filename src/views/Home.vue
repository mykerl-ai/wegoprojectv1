<template>
  <Hero>
    ...
    <h1 class="lg:text-3xl md:8xl tracking-wide leading-10 text-2xl -mt-20 md:-mt-12 text-white font-semibold">Revolutionary <br> End-to-End IPTV/OTT Combined Platform</h1>
    </template>
