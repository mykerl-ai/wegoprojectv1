...
<PodcastNav />
  ...
  <div class="w-full shadow-lg py-1 px-2 mt-4">
      <h1 class="text-base mx-4 text-white">Playlist schedule</h1>
      
      <div class="flex flex-wrap mt-12 gap-6 md:mx-40">
            <button v-for="day in days" :key="day.id" @click="checkId(day.id)" class="focus:bg-blue focus:outline-none focus:text-white bg-none text-white hover:bg-blue hover:text-white  text-sm px-2 py-2 rounded rounded-full">{{day.day}}</button>
