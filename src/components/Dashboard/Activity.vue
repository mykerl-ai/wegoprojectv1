<template>
  ...
  <div class="w-full my-4 cards gap-4 grid grid-cols-1 md:grid-cols-4">
    <div
      @click="handleActivity(icon.id)"
      v-for="icon in icons"
      :key="icon.id"
      class="shadow-xl bg-white py-6 px-4 cursor-pointer"
    >
      <svg
        class="mx-auto my-6"
        :id="icon.id"
      ...
      <h2 class="text-xs mt-8 text-center font-semibold text-deep-gray ">
        <button
          type="button"
          class="btn focus:outline-none"
          @click="showModal(icon.id)"
        >
          {{ icon.title }}
        </button>
      </h2>
        ...
        >
          <g id="Icon" transform="translate(-1155 -1397)">
            <path
              ...
              transform="translate(1155 1397)"
              fill="#e8e7ff"
            />
            <path
              id="Icon_material-playlist-play"
              data-name="Icon material-playlist-play"
              d="M19.057,11.825H3v2.162H19.057Zm0-4.325H3V9.662H19.057ZM3,18.312H15.279V16.149H3Zm14.168-2.162v6.487l4.723-3.243Z"
              transform="translate(1161.555 1401.932)"
              fill="#0080ff"
            />
          </g>
        </svg>
  ...
  <Modal v-if="isModalVisible && id == 'uploadLink'" @close="closeModal">
    ...
    <template v-slot:body>
      <form class="w-full" action="">
        ...
        <div class="focus-within:none">
          <label class="text-xs text-gray px-4 block" for="pic"
            >Cover Image (jpeg, PNG)</label
          >
          <input
            type="file"
            name="pic"
    ...
    return {
      ...
      icons: [
...

        {
          ...
          width: "50",
          height: "50.76",
          viewBox: "0 0 50 50.76",
          pathId: "Icon_material-playlist-add",
          dataName: "Icon material-playlist-add",
          d:
...

        {
          ...
          dataName: "Path 350",
          d:
            "M27.585,24.21a9.855,9.855,0,1,0-9.855-9.855A9.884,9.884,0,0,0,27.585,24.21Zm0,4.927c-6.529,0-19.71,3.326-19.71,9.855v4.927H47.294V38.992C47.294,32.463,34.113,29.137,27.585,29.137Z",
          transform: "translate(0 3.105)",
          fill: "#00acc1",
          title: "Add Existing customer(s)",
          file: "CSV File",
        },
      ],
      movies: [
